...
BuildRequires:  crate(anstream-0.6) >= 0.6.21
BuildRequires:  crate(anstyle-1.0) >= 1.0.13
BuildRequires:  crate(anstyle-parse-0.2) >= 0.2.7
...
BuildRequires:  crate(clap-4.0) >= 4.5.56
BuildRequires:  crate(clap-builder-4.0) >= 4.5.56
BuildRequires:  crate(clap-derive-4.0) >= 4.5.55
BuildRequires:  crate(clap-lex-0.7) >= 0.7.7
BuildRequires:  crate(colorchoice-1.0) >= 1.0.4
...
BuildRequires:  crate(pcre2-0.2) >= 0.2.9
BuildRequires:  crate(pcre2-sys-0.2) >= 0.2.9
...
%check
%__cmake --build "%{__cmake_builddir}" --target fish_run_tests
